Pod::Spec.new do |s|
  ...
  s.version      = "0.0.2"
  s.summary      = "The Ultimate Parental Gate to help block children from accessing in app purchase. Combines both math and dexterity skills."
  s.description  = <<-DESC
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/henrytkirk/HTKUltimateParentalGate.git", :tag => "v0.0.2" }
  s.resource_bundles = { 'HTKUltimateParentalGate' => 'HTKUltimateParentalGate/**/*.{plist}' }
